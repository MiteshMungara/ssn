...
-(void)CopyDatabaseInDevice
{
  ...
  //  KidsDB.sqlite
    ...
    NSString *sourcepath = [[NSBundle mainBundle] pathForResource:@"SSNValidatorDB" ofType:@"db"]; // get source path
...
//    NSLog(@"\n\n IMAGE PATH>> %@ \n\n",self.ImageFolderPath);
    ...
    strDestPath = [strDestPath stringByAppendingPathComponent:@"SSNValidatorDB.db"]; // slash add karava mate
